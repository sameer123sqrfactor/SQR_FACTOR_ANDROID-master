...
import com.user.sqrfactor.Activities.CompetitionEditActivity;
...
import com.user.sqrfactor.Utils.MyMethods;
...
public class CompetitionsAdapter extends RecyclerView.Adapter<CompetitionsAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        MyViewHolder(View view) {
            ...
            //compMenu = view.findViewById(R.id.comp_menu);

            participateButton = view.findViewById(R.id.participate);

            shareFab = view.findViewById(R.id.competition_share);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.participate: {
                    ...
                    i.putExtra(BundleConstants.COMPETITION_NAME,competition.getCompetitionName());
    ...
    public CompetitionsAdapter(Context context, List<CompetitionClass> competitions, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (competition != null) {
           ...
           // Picasso.get().load(ServerConstants.IMAGE_BASE_URL + competition.getImageUrl()).into(holder.competitionImageView);
            ...
            UserClass userClass=UtilsClass.GetUserClassFromSharedPreferences(mContext);
            Log.d(TAG, "onBindViewHolder: my user id = " + myUserId);

//            if (compUserId.equals(userClass.getUserId())||Integer.parseInt(compUserId)==userClass.getUserId()) {
