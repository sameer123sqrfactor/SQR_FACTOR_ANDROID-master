...
public class PostContentHandlerForSubmissionData {
    Context context;
    String  content;
    LinearLayout linearLayout;
    TextView fullPostDescription;

    public PostContentHandlerForSubmissionData(Context context, String content, LinearLayout linearLayout, TextView fullPostDescription) {
    ...
    public void setContentToView(){
        ...
        for(Element element :elements){
            ...
            if(tag.getName().equalsIgnoreCase("a")){
                ...
                {
                    if(s.equals("")||s.equals("b")||s.equals("/b")||s.equals("/span")||s.equals(":")||s.equals("i")||s.equals("br")||s.equals(".")||s.equals("/i"))
                    {
                        continue;
                    }
                    else{
