...
public class UserClassSharedPreferences {


    private static UserClassSharedPreferences mInstance= null;
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor prefsEditor;

    private UserClassSharedPreferences(Context context) {
        sharedPreferences = context.getSharedPreferences("User", Activity.MODE_PRIVATE);
        prefsEditor = sharedPreferences.edit();
    }

    public static void init(Context context) {
        mInstance = new UserClassSharedPreferences(context);

    }


    public static UserClassSharedPreferences getInstance() {
        if (mInstance == null) {
